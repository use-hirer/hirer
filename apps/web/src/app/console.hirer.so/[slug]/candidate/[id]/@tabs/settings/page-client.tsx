...
const JobConfigurationClientPage: React.FC = () => {
  ...
  return (
    <div className="mt-4">
      <Card className="rounded-md border-red-400 flex-grow-0 shadow-sm">
        <CardHeader>
        ...
        <CardFooter className="border-t border-red-400 py-4 bg-red-50 flex justify-end rounded-b-md">
          <Button
...
export default JobConfigurationClientPage;
