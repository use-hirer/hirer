...
import { CANDIDATES_TABLE_COLUMNS } from "./candidates-columns";

interface NavigationPanelProps {
  table: Table<RouterOutputs["candidate"]["getMany"][number]>;
}
...
interface CandidatesTableProps {
  preview?: boolean;
  data: RouterOutputs["candidate"]["getMany"];
}

export function CandidatesTable({ preview, data }: CandidatesTableProps) {
          ...
          <tbody>
            {table.getRowModel().rows?.length ? (
              ...
              <tr className="border-b border-b-red-700">
                <td
                  colSpan={CANDIDATES_TABLE_COLUMNS.length}
